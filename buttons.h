...
public:
	...
	Uint32 usedColor;
	ToggleButton();
	ToggleButton( unsigned int setX, unsigned int setY, unsigned int setWidth, unsigned int setHeight, Uint32*& setPixels );
	void draw( unsigned int mouseX, unsigned int mouseY, bool mousePressed, unsigned int windowWidth );
};
...
public:
	...
	Uint32 usedColor;
	PushButton();
	PushButton( unsigned int setX, unsigned int setY, unsigned int setWidth, unsigned int setHeight, Uint32*& setPixels );
	void draw( unsigned int mouseX, unsigned int mouseY, bool mousePressed, unsigned int windowWidth );
};
